...
class Telemetry
{
    ...
    private:
        SimpleLog* logger_;                             /**< Log object */
        TinyGPSPlus gps_;                               /**< Defines Tiny GPS object */
        Stream* gps_serial_;                            /**< Defines Stream object for GPS device serial port */
        SimpleBuffer* gps_serial_buffer_;               /**< Buffer to store received GPS serial data in for sending out to other devices */
