...
class MissionState
{
    ...
    private:
        ...
        SimpleTimer recovered_timeout_;                         /**< Timer for recovered mode time-out */
        SimpleTimer descent_timeout_;                           /**< Timer for checking descent */
        SimpleTimer landing_timeout_;                           /**< Timer for checking landing */
